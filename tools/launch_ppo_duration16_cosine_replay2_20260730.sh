...
run_root="${repo_root}/artifacts/ppo_gold_duration16_cosine_replay2_tailconsensus5_ow8_ctx34q2_ordered_seed20260763_20260730"
...
PYTHONUNBUFFERED=1 \
  ...
  "${repo_root}/tools/run_ppo_duration16_cosine_replay2_20260730.py" \
  > "${log_path}" 2>&1
status=$?
