#!/usr/bin/env python3
"""One-shot, hash-bound two-panel broad evaluation for the materialized E904.
...
The runner is deliberately self-contained and does not consume the older
pre-training-source protocol used by the frozen multi-candidate runner.
...
SCRIPT = ROOT / "tools/run_e904_single_candidate_broad_v1.py"
EXPECTED_PYTHON = Path("/home/xxc/miniconda3/envs/my_project_env/bin/python")

CANDIDATE = ROOT / (
    "artifacts/ppo_u468_raw_actor6_metricguard_fulltrain_cw10_"
    "materialized_v1_20260802/u468-cw10-fulltrain-pass-eval-only.pt"
)
CANDIDATE_SHA256 = (
...
OUTPUT_ROOT = ROOT / "artifacts/e904_cw10_single_candidate_broad_v1_20260802"
ATTEMPT_MARKER = ROOT / (
    "artifacts/.ptcg-e904-cw10-single-candidate-broad-v1-20260802-attempt.json"
)
TERMINAL_FAILURE = ROOT / (
    "artifacts/.ptcg-e904-cw10-single-candidate-broad-v1-20260802-"
...
def make_bindings(runner_sha256: str) -> list[HeldInput]:
    return [
        HeldInput("runner", SCRIPT, runner_sha256),
        HeldInput("candidate", CANDIDATE, CANDIDATE_SHA256),
...
def static_preflight(runner_sha256: str) -> dict[str, Any]:
    ...
    try:
        ...
        return {
            "schema_version": "ptcg-e904-single-candidate-broad-preflight-v1",
...
def write_terminal_failure(
    ...
    payload = canonical_json_bytes(
        {
            "schema_version": "ptcg-e904-single-candidate-broad-terminal-failure-v1",
...
def formal_execute(runner_sha256: str) -> dict[str, Any]:
    ...
    try:
        ...
        marker_payload = canonical_json_bytes(
            {
                "schema_version": "ptcg-e904-single-candidate-broad-attempt-v1",
        ...
        manifest_document = {
            "schema_version": "ptcg-e904-single-candidate-broad-manifest-v1",
        ...
        decision_document = {
            "schema_version": "ptcg-e904-single-candidate-broad-decision-v1",
            ...
            "authorization": {
                "gold_local_evaluation_authorized": passed,
...
def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(
        description=(
            "Preflight or explicitly execute the frozen E904 two-panel broad gate."
        )
    )
    parser.add_argument(
        "--mode",
