#!/usr/bin/env python3
"""Audit or execute the frozen U473-U476 exact-gold12 PPO continuation."""
...
SCHEMA = "ptcg-design202608152-u473-u476-exactgold12-execution-v1"
SEED = 202608152
...
PARENT_SHA256 = "c0436d54fff5e4da62d94c3002775c9e4b9ee848c5c59dd4422943cd71ad7018"
...
OUTPUT_ROOT = ROOT / "artifacts/ppo_u472_exactgold12_crossdeck_ppo4x96_u476_design202608152"
OUTPUT_DIR = OUTPUT_ROOT / "B_gold_league/seed-202608152"
TERMINAL = OUTPUT_DIR / "checkpoints/update-0476.pt"
ATTEMPT = ROOT / ".ptcg-design202608152-u473-u476-attempt.json"
LOG = ROOT / "artifacts/ppo_u472_exactgold12_crossdeck_ppo4x96_u476_design202608152.log"
...
def input_bindings(protocol_path: Path) -> dict[Path, str]:
    result = {
        ...
        protocol_path: sha256_file(protocol_path),
        BASE: BASE_SHA256,
