...
run_root="${repo_root}/artifacts/ppo_gold_duration12_cosine_tailconsensus5_ow8_ctx34q2_ordered_seed20260760_20260730"
...
PYTHONUNBUFFERED=1 \
  ...
  "${repo_root}/tools/run_ppo_duration12_cosine_20260730.py" \
  > "${log_path}" 2>&1
status=$?
