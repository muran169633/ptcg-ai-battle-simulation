...
run_root="${repo_root}/artifacts/ppo_gold_duration32_cosine_tailconsensus5_ow8_ctx34q2_ordered_seed20260739_20260729"
...
PYTHONUNBUFFERED=1 \
  ...
  "${repo_root}/tools/run_ppo_duration32_cosine_20260729.py" \
  > "${log_path}" 2>&1
status=$?
