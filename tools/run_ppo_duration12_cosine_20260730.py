#!/usr/bin/env python3
"""Run the final frozen duration-12 cosine PPO horizon experiment."""
...
OUTPUT_DIR = (
    ROOT
    / "artifacts"
    / "ppo_gold_duration12_cosine_tailconsensus5_ow8_ctx34q2_ordered_seed20260760_20260730"
    / "B_gold_league"
    / "seed-20260760"
)
...
def main() -> None:
    ...
    set_flag(command, "--updates", "452")
    set_flag(command, "--eval-interval", "452")
    set_flag(command, "--checkpoint-interval", "452")
    set_flag(command, "--seed", "20260760")
    ...
    if command[command.index("--schedule-start-update") + 1] != "441":
        raise RuntimeError("Cosine phase must span updates 441 through 452")
