...
six exactly-once commands.  It also binds the rejected-before-run v1 runner,
builder, and preregistration and requires the v1 attempt/output targets to stay
absent.
...
TOOLS = ROOT / "tools"
SCRIPT = TOOLS / "build_u469_consumed_specialist_dev_consistency_preregistration_v2.py"
EXPECTED_PYTHON = Path("/home/xxc/miniconda3/envs/my_project_env/bin/python")
FROZEN_MODE = 0o555

EXECUTOR = TOOLS / "run_u469_single_endpoint_consumed_specialist_dev_consistency_v2.py"
EXECUTOR_SHA256 = "6dceb60407f7e5e16efa55ff77fc715293ded62959d7b35e2fbfc52bbc31f8be"
...
def require_targets_absent(*, include_preregistration: bool) -> dict[str, bool]:
    targets = {
        ...
        "predecessor_v1_output_root": executor.PREDECESSOR_V1_OUTPUT_ROOT,
        "predecessor_v1_attempt_marker": executor.PREDECESSOR_V1_ATTEMPT_MARKER,
...
def build_document() -> tuple[dict[str, Any], dict[str, Any]]:
    ...
    predecessor_binding = executor.expected_predecessor_v1_binding()
    predecessor_evidence, _ = executor.verify_predecessor_v1(predecessor_binding)
    ...
    document = {
        ...
        "predecessor_v1": predecessor_binding,
...
def main() -> None:
    ...
    result = {
        "schema_version": "ptcg-u469-consumed-specialist-dev-consistency-builder-result-v2",
        ...
        "predecessor_v1": audit["predecessor_v1"],
